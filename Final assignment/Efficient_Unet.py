...
class Model(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=19):
        ...
        self.head_conv = nn.Conv2d(in_channels=16, out_channels=n_classes, kernel_size=3, padding=1, bias=False)
...
# model = Model()    
# dummy_input = (64, 3, 256, 256)
# summary(model, dummy_input, col_names = ('input_size','output_size', 'num_params', 'kernel_size'))
# macs, params = profile(model, inputs=(torch.randn(dummy_input),))
